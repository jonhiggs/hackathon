...
$query = $database->exec("INSERT INTO pokemon (id, type, image_path) VALUES (1, 'Bulbasaur', '001.png');");
$query = $database->exec("INSERT INTO pokemon (id, type, image_path) VALUES (4, 'Charmander', '004.png');");
$query = $database->exec("INSERT INTO pokemon (id, type, image_path) VALUES (7, 'Squirtle', '007.png');");
